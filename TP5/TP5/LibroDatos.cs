    ...
    public void InsertLibro(Libro libro)

        {
            try
            {
                ...
                string query = "INSERT INTO Libros (Titulo, Autor, Paginas, Edicion, Editorial, ISBN, Lugar) VALUES (@Titulo, @Autor, @Paginas, @Edicion, @Editorial, @ISBN, @Lugar)";
        ...
        public List<Libro> GetLibro(string buscar = null)
        {
            ...
            {
                cn.Open();
                string query = @"SELECT IdLibro,Titulo,Autor,Paginas,Edicion, Editorial, ISBN, Lugar
                                   FROM Libros";
                SqlCommand comando = new SqlCommand();
                if (!string.IsNullOrEmpty(buscar))
                {
                    
                    query += @" WHERE Titulo LIKE @Buscar OR Autor LIKE @Buscar OR Paginas LIKE @Buscar OR Edicion LIKE @Buscar OR Editorial LIKE @Buscar OR ISBN LIKE @Buscar OR Lugar LIKE @Buscar";
        ...
        public void UpdateLibro(Libro libro)
        {
            try
            {
                ...
                string query = @"
                                 UPDATE  Libros
                       SET Titulo=@Titulo, Autor = @Autor, Paginas = @Paginas, Edicion = @Edicion, Editorial = @Editorial, ISBN = @ISBN, Lugar = @Lugar
